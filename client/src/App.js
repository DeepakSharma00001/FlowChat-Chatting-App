      ...
      <div className="container-fluid p-0">
        ...
        <div className="bg-light py-5 mb-5">
          <div className="container text-center">
            ...
            FlowChat: The ultimate chat platform designed for seamless,
            real-time conversations. Connect effortlessly with friends, 
            family, and colleagues. With Flowchat, enjoy a sleek interface, 
            robust security, and features that make every interaction vibrant 
            and meaningful. Experience communication reimagined – dive into 
            the flow of conversation with Flowchat!
            </p>
          </div>
        </div>
    ...
    <div className="container-fluid vh-100 d-flex flex-column">
      <div className="row py-3 bg-light border-bottom">
        <div className="col-12 text-center">
          <h1 className="h3 text-primary mb-0">FlowChat</h1>
          <p className="mb-2">
